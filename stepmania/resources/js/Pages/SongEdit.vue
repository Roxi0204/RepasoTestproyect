...
onMounted(() => {
  form.titulo = props.song.title
  form.artista = props.song.artist
  form.duracion = props.song.duration
  form.album = props.song.album.id
})
console.log(props.song.album.title);
function save() {
